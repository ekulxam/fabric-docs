...
Bu kılavuz, Linux'ta Java 21'i yükleme konusunda size yol gösterecektir.
...
Bir terminal açın, `java -version` yazın ve <kbd>Enter</kbd> tuşuna basın.

!["java -version" yazılmış terminal](/assets/players/installing-java/linux-java-version.png)
