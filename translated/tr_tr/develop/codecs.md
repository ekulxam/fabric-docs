---
title: Kodlayıcılar
description: Serileştirme ve tersine serileştirme için Mojang'ın kodlayıcı sistemini kullanmak ve anlamak için kapsamlı bir rehber.
authors:
  - enjarai
  - Syst3ms
---

Kodlayıcı, Java objeclerini kolaylıkla serileştiren bir sistemdir ve Minecraft'a dahil olan Mojang'ın DataFixerUpper (DFU) kütüphanesine dahil edilmiştir. In a modding context they can be used as an alternative
...
## Kodlayıcıları Kullanmak {#using-codecs}

### Serileştirme ve Tersine Serileştirme {#serializing-and-deserializing}

Bir kodlayıcının temel kullanımı, objeleri belirli bir formattan serileştirmek veya belirli bir formata serileştirmekdir.
...
### Yerleşik Kodlayıcılar {#built-in-codecs}
...
#### İsteğe Bağlı Alanlar {#optional-fields}
