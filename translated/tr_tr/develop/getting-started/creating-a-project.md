---
title: Proje Yaratmak
description: Fabric template mod generator kullanarak yeni bir mod projesi yaratmak hakkında bir kılavuz.
authors:
  - Cactooz
  - MB11
  - radstevee
...
Fabric yeni bir mod projesini kolayca oluşturmanız için Fabric Template Mod Generator'ı kullanmanıza olanak tanır - isterseniz örnek mod veri havuzunu kullanarak manuel olarak yeni bir proje oluşturabilirsiniz, [Manuel Proje Oluşturma](#manual-project-creation) bölümüne bakınız.

## Proje Oluşturuluyor {#generating-a-project}
