...
Minecraft dispose d'une grande sélection de sons parmi lesquels vous pouvez choisir. Check out the `SoundEvents` class to view all the vanilla sound event instances that Mojang has provided.
