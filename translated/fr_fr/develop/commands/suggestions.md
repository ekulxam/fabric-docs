...
Minecraft dispose d'un puissant système de suggestion de commandes qui est utilisé à de nombreux endroits, comme la commande `/give`. Ce système vous permet de suggérer à l'utilisateur des valeurs pour les arguments de la commande, qu'il peut ensuite sélectionner - c'est un excellent moyen de rendre vos commandes plus conviviales et ergonomiques.
