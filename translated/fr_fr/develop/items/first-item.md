---
title: Créer votre premier Objet
description: Apprenez comment enregistrer un objet (`Item`) avec une texture, un modèle et un nom.
authors:
  - dicedpixels
  - Earthcomputer
  - IMB11
...
Cette page va présenter les éléments clés concernant les objets, et comment les enregistrer, définir une texture, définir un modèle et le nommer.
