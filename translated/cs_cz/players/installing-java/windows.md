---
title: Instalace Javy na Windowsu
...
Abyste zkontrolovali, jestli je Java již nainstalovaná, nejdříve musíte otevřít terminál.
...
Po otevření terminálu napište `java -version` a stiskněte <kbd>Enter</kbd>.
