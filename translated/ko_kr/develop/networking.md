---
title: 네트워킹
description: Fabric API를 이용한 네트워킹 가이드
authors:
  - Daomephsta
  - dicedpixels
  - Earthcomputer
...
Minecraft에서 네트워킹은 클라이언트와 서버가 서로 통신할 때 사용됩니다. 네트워킹은 꽤나 광범위한 주제이기 때문에, 본 문서에서는 몇 가지 카테고리로 나누어 설명할 것입니다.

## 네트워킹이 중요한 이유 {#why-is-networking-important}

패킷은 Minecraft 네트워킹의 핵심 개념입니다.
