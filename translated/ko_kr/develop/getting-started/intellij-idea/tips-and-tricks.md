...
description: IDE를 사용하여 프로젝트롤 효율적으로 다룰 수 있도록 하는 유용한 정보.
authors:
  - AnAwesomGuy
  - Earthcomputer
  - JR1811
...
이 페이지는 유용한 정보를 제공합니다. 따라서, 개발자의 워크플로우를 단순화하고 가속시킬 수 있습니다. 필요하다면 속에 익힐 수 있습니다.
It may take some time to learn and get used to the shortcuts and other options. 이 페이지를 참조하여 사용할 수 있습니다.
