...
### Fabric Loader JUnit 세팅 {#setting-up-fabric-loader-junit}
...
![테스트 메서드 생성](/assets/develop/misc/automatic-testing/unit_testing_01.png)
...
![테스트 지시자를 통한 빈 테스트 메서드](/assets/develop/misc/automatic-testing/unit_testing_02.png)
...
#### 레지스트리 세팅 {#setting-up-registries}
...
### GitHub Actions 세팅 {#setting-up-github-actions}
