...
![직사각형](/assets/develop/rendering/draw-context-rectangle.png)

### 경계 그리기 {#drawing-outlines-borders}
...
![경계가 있는 직사각형](/assets/develop/rendering/draw-context-rectangle-border.png)

### 개별적인 선 그리기 {#drawing-individual-lines}
...
![라인](/assets/develop/rendering/draw-context-lines.png)

## 시저 매니저(Scissor Manager) {#the-scissor-manager}
...
### 시저 매니저 사용하기 {#using-the-scissor-manager}
