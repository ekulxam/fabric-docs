...
Fabric 문서는 [VitePress](https://vitepress.dev/)를 이용하여 다양한 Markdown 파일에서 정적 HTML을 생성합니다. You should familiarize yourself with the [Markdown extensions that VitePress supports](https://vitepress.dev/guide/markdown#features).
