---
title: Panduan Pemindahan Fabric API 26.1
description: Panduan untuk mengemas kini mod anda kepada Fabric API untuk Minecraft 26.1.
authors:
  - modmuss50
---

Memandangkan Minecraft 26.1 kini tidak dikaburkan, kebanyakan pembangun kini akan menggunakan pemetaan rasmi Mojang. Sebelum ini, Fabric API dibina dengan mengambil kira pemetaan Yarn, tetapi dengan peralihan kepada pemetaan rasmi, nama API telah dikemas kini agar sepadan dengan nama rasmi jika berkenaan. Perubahan ini tidak serasi ke belakang, jadi anda perlu mengemas kini mod anda untuk menggunakan nama baharu. Penamaan semula API ini tidak akan dikendalikan oleh alat pemetaan migrasi, sangat disyorkan untuk mengikuti [Pemetaan Migrasi](../../migrating-mappings/) terlebih dahulu jika mod anda dibina dengan pemetaan Yarn.

Berikut ialah senarai semua kelas, kaedah dan medan yang dinamakan semula dalam Fabric API 26.1, cara terbaik untuk menggunakan senarai ini adalah dengan mencari (<kbd>⌘/CTRL</kbd>+<kbd>F</kbd>) halaman ini untuk nama lama dan menggantikannya dengan nama baharu.

An IntelliJ IDEA migration map is also available to help automate renaming the classes. Selepas memuat turun, ikut arahan dalam [dokumentasi JetBrains](https://www.jetbrains.com/help/idea/migrate.html) untuk mengaplikasikannya pada projek anda.

<DownloadEntry downloadURL="/assets/develop/porting/fabric-api-26-1-migration-map.xml">peta pemindahan kelas</DownloadEntry>

## Senarai Penamaan Semula {#renames}
