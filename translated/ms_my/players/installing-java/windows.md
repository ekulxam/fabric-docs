---
title: Memasang Java pada Windows
...
Pelancar Minecraft didatangkan dengan pemasangan Java sendiri, jadi bahagian ini hanya relevan jika anda mahu menggunakan pemasang berasaskan `.jar` Fabric atau jika anda mahu menggunakan `.jar` Pelayan Minecraft.

## 1. Check if Java Is Already Installed {#1-check-if-java-is-already-installed}

Untuk menyemak sama ada Java telah dipasang, anda mesti membuka command prompt terlebih dahulu.
