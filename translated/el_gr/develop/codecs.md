---
title: Κωδικοποιητές
description: Ένας περιεκτικός οδηγός για την κατανόηση και τη χρήση του συστήματος κωδικοποίητων της Mojang για σειριοποίηση και αποσειροποίηση αντικειμένων.
authors:
  - enjarai
  - Syst3ms
---
