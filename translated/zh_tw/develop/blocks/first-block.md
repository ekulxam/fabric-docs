---
title: 製作你的第一個方塊
description: 了解如何在 Minecraft 中建立您的第一個自訂方塊。
authors:
  - CelDaemon
  - Earthcomputer
  - IMB11
...
方塊是Minecraft的基礎元素 (無雙關語) - 和Minecraft中的其他東西一樣，它們都儲存在註冊表中。

## 準備你的方塊類別 {#preparing-your-blocks-class}

如果你已經完成了[創建你的第一個物品](../items/first-item)，那麼這一過程會非常熟悉——你會需要創建一個註冊方塊以及方塊物品的方法。

你應該把這個方塊放在叫做 `ModBlocks` 的類中（也可以是其他你想要的名稱）。
...
像物品一樣，你需要確保類被加載，這樣所有包含方塊實體的靜態字段都會初始化。
