---
title: Parametry Komend
description: Naucz się jak stworzyć komendy ze skomplikowanymi parametrami.
---

Parametry są użyte w większości komend. Czasami one mogą być opcjonalne, co oznacza, że jeśli nie podasz tego argumentu, ta komenda i tak zadziała. One node may have multiple argument types, but be aware that there is a possibility of
