---
title: Кодеклар
description: Объектларны серияләштерү һәм десерияләштерү өчен Mojang'ның кодеклар системасын аңлау һәм куллану өчен тулы кулланма.
authors:
  - enjarai
  - Syst3ms
---

Codec — Java'дагы объектларны җиңел серияләштерү системасы һәм ул Minecraft белән кертелгән Mojang'ның DataFixerUpper (DFU) китапханәсенә керә. In a modding context they can be used as an alternative
...
| `Codec<A>#comapFlatMap` | Юк                   | Yes                  |
| `Codec<A>#flatComapMap` | Yes                  | Юк                   |
| `Codec<A>#flatXMap`     | Юк                   | Юк                   |
