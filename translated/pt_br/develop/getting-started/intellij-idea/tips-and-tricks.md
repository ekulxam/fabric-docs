...
description: Informação útil para gerenciar e navegar seu projeto usando o IDE de forma eficiente.
authors:
  - AnAwesomGuy
  - Earthcomputer
  - JR1811
...
Esta página oferece informações úteis para acelerar e facilitar o fluxo de trabalho de desenvolvedores. Incorpore-as ao seu, conforme preferir.
Pode levar algum tempo para aprender e se acostumar aos atalhos e outras opções. Você pode usar esta página como referência para isso.
