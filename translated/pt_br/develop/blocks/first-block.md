...
Se você completou [Criando seu Primeiro Item](../items/first-item), esse processo será extremamente familiar, você precisará criar um método que registre seu bloco, e o item dele.

Você deve colocar esse método na classe chamada `ModBlocks` (ou o que você quiser chamar).
