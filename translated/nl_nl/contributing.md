---
title: Bijdrage Richtlijnen
description: Richtlijnen voor bijdrages aan de Fabric Documentatie
---

Deze website gebruikt [VitePress](https://vitepress.dev/) om statische HTML te genereren van meerdere Markdown bestanden. You should familiarize yourself with the [Markdown extensions that VitePress supports](https://vitepress.dev/guide/markdown#features).

Er zijn drie manieren waarop je kan bijdragen aan deze website

- [Documentatie Vertalen](#translating-documentation)
- [Inhoud Bijdragen](#contributing-content)
- [Framework bijdragen](#contributing-framework)

Alle bijdrages moeten onze [stijl richtlijnen](#style-guidelines) volgen.

## Documentatie Vertalen  {#translating-documentation}

Als je de documentatie wil vertalen in jouw taal, kan je dit doen op de [Fabric Crowdin pagina](https://crowdin.com/project/fabricmc).

<!-- markdownlint-disable titlecase-rule -->

## <Badge type="tip">nieuwe-inhoud</Badge> Inhoud bijdragen {#contributing-content}
