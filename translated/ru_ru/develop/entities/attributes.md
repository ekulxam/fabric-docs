...
Attributes determine the properties that your modded entity can possess. Используя Fabric, вы можете создавать собственные которые улучшают игровые механики и также используют ванильные.

## Создание собственного атрибута {#creating-a-custom-attribute}
